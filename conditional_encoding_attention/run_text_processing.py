...
def read_data(base_path = '/home/neha/sem2/nlu/project/stance_detection-master/code', name = "train"):
    
    # Extracting data
    dataset = DataSet(path = base_path + '/data',name=name)
...
def save_data_pickle(outfilename, 
    ...
    if embedding_type == 'twitter.27B.50d':
        ...
        filename_embeddings = cwd + '/../../glove.6B.50d.txt'
...
#     h_b_ids, h_b_np, seqlen = concatConvert_np(h_ids, b_ids)
#     
#     save_data_pickle(outfilename='/data/glove50d_h_ids_b_ids_comp_pickle.p',embedding_type = 'abc')
#    
