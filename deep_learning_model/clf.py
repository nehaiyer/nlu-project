...
class Conv1(object):
    ...
    def __call__(self, inp):
        ...
        #conv_out = dnn_conv(inp, self.w, subsample=(1,self.stride), border_mode=(0,self.pad), filter_dilation=(1,self.dilate))+self.b.dimshuffle('x',0,'x','x')
...
if __name__ == '__main__':
    ...
    val_news = News(stances='test.csv', bodies='test_bodies.csv', vecs=v)
